export default {
  ...
  LABEL_REVIEW_DECISION_CHANGES_REQUESTED: '',
  LABEL_REVIEW_DECISION_CONFORM: 'TEST TEXT FOR CONFORM',
  LABEL_REVIEW_DECISION_NON_CONFORM: 'TEST TEXT FOR NON-CONFORM',
  LABEL_REVIEW_DECISION_LOQ: 'TEST TEXT FOR LIST OF QUESTIONS',
