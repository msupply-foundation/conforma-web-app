export default {
  ...
  EVALUATOR_FRAGMENT_SELECT_FRAGMENT: 'Select fragment',
  EVALUATOR_FRAGMENTS_UPDATE_PROBLEM: 'Problem updating fragment!',
  EVALUATOR_FRAGMENT_SAVED: 'Evaluator fragment saved',
  EVALUATOR_FRAGMENT_DELETE_PROBLEM: 'Problem deleting fragments!',
  ...
  EVALUATOR_FRAGMENT_NAME_CHANGED: 'Fragment name has changed',
  EVALUATOR_FRAGMENT_NAME_CHANGE_MESSAGE:
    'You have changed the name of the fragment. Do you want to continue editing the current fragment or save it as a new fragment?',
  EVALUATOR_FRAGMENT_CONFIRM_EDIT: 'Edit existing',
  EVALUATOR_FRAGMENT_CONFIRM_NEW: 'Create new',
  EVALUATOR_FRAGMENT_CONFIG_SAVE_WARNING: 'Save fragment?',
  EVALUATOR_FRAGMENT_CONFIG_SAVE_MESSAGE: 'This will overwrite the current fragment configuration',
  EVALUATOR_FRAGMENT_CONFIG_ADD_MESSAGE: 'This will save a NEW fragment configuration',
  ...
  JSON_EDIT_SEARCH_PLACEHOLDER: 'Search properties',
